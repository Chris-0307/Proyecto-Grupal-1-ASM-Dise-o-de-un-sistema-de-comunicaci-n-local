# main.py (Receptor Pico W - v11.1 - Lógica Arreglada)
    ...
    if ascii_state == "IDLE":
        ...
        if utime.ticks_diff(current_time, last_bit_time) > BIT_PERIOD_MS:
            ...
            if bit_count == 8:
                ...
                # Terminamos. El Stop Bit (F0) se leerá en el siguiente ciclo,
...
def run_detector():
    ...
    while True:
        ...
        # --- Lógica de Decisión (¡YA NO ES PEGAJOSA!) ---
